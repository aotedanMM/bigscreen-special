...
(function (a, b, c, d, e, f) {
    ...
    function h(a, c, d, e, f) {
        var g = c.contentWindow, h = new Lb(g.document), m = new G(d, h), n = Q(a),
            o = "view" === d.type ? e : k(g.document), p = "view" === d.type ? f : l(g.document),
            q = new d.renderer(o, p, m, d, b), r = new S(a, q, h, m, d);
    ...
    function B(a, c) {
        var d, e, f = b.createElement("div"), g = b.createElement("img"), h = b.createElement("span"),
            i = "Hidden Text";
    ...
    function H(a) {
        ...
        b ? a.args[0].split(" ").reverse().forEach(function (a) {
            ...
            return {color: new z(b[1]), stop: "%" === b[3] ? b[2] / 100 : null}
    ...
    function R(a) {
        var b = a.offsetParent ? R(a.offsetParent) : {top: 0, left: 0};
        return {
    ...
    function X(a, b, c, d) {
        ...
        return {
            topLeft: Z({x: a, y: i}, {x: a, y: i - g}, {x: h - f, y: b}, {x: h, y: b}),
            topRight: Z({x: a, y: b}, {x: a + f, y: b}, {x: h, y: i - g}, {x: h, y: i}),
            bottomRight: Z({x: h, y: b}, {x: h, y: b + g}, {x: a + f, y: i}, {x: a, y: i}),
            bottomLeft: Z({x: h, y: i}, {x: h - f, y: i}, {x: a, y: b + g}, {x: a, y: b})
        }
    }
    ...
    if (function () {
            ...
            function h() {
                var a = 0, c = new E(k), d = b.createTextNode("");
            ...
            var A, B = Array.isArray ? Array.isArray : function (a) {
                ...
                }, C = 0, D = "undefined" != typeof a ? a : {}, E = D.MutationObserver || D.WebKitMutationObserver,
    ...
    !function (a) {
        ...
        function m(a) {
            var c, d, e, f, g, h, k, m, n, o, p = [], q = a.length, r = 0, s = C, t = B;
        ...
        function n(a) {
            ...
            for (e = f = u.length, f && u.push(D); q > e;) {
                ...
                for (r = e + 1, j - c > J((v - d) / r) && b("overflow"), d += (j - c) * r, c = j, i = 0; q > i; ++i) if (p = a[i], c > p && ++d > v && b("overflow"), p == c) {
        ...
        var q = "object" == typeof c && c && !c.nodeType && c,
            r = "object" == typeof module && module && !module.nodeType && module, s = "object" == typeof d && d;
        (s.global === s || s.window === s || s.self === s) && (a = s);
        var t, u, v = 2147483647, w = 36, x = 1, y = 26, z = 38, A = 700, B = 72, C = 128, D = "-", E = /^xn--/,
            F = /[^\x20-\x7E]/, G = /[\x2E\u3002\uFF0E\uFF61]/g, H = {
        ...
        if (t = {
            ...
            return t
        }); else if (q && r) if (module.exports == q) r.exports = t; else for (u in t) t.hasOwnProperty(u) && (q[u] = t[u]); else a.punycode = t
    }(this);
    var Vb = "data-html2canvas-node", Wb = "data-html2canvas-canvas-clone", Xb = 0, Yb = 0;
    a.html2canvas = function (c, d) {
        ...
        if (d = d || {}, d.logging && (a.html2canvas.logging = !0, a.html2canvas.start = Date.now()), d.async = "undefined" == typeof d.async ? !0 : d.async, d.allowTaint = "undefined" == typeof d.allowTaint ? !1 : d.allowTaint, d.removeContainer = "undefined" == typeof d.removeContainer ? !0 : d.removeContainer, d.javascriptEnabled = "undefined" == typeof d.javascriptEnabled ? !1 : d.javascriptEnabled, d.imageTimeout = "undefined" == typeof d.imageTimeout ? 1e4 : d.imageTimeout, d.renderer = "function" == typeof d.renderer ? d.renderer : Tb, d.strict = !!d.strict, "string" == typeof c) {
            ...
            var i = null != d.width ? d.width : a.innerWidth, j = null != d.height ? d.height : a.innerHeight;
    ...
    C.prototype.getMetrics = function (a, b) {
    ...
    }, E.prototype.TYPES = {LINEAR: 1, RADIAL: 2}, G.prototype.findImages = function (a) {
        var b = [];
        ...
        if (M(f[0])) d = a.width * parseFloat(f[0]) / 100; else {
            if (/contain|cover/.test(f[0])) {
                var g = a.width / a.height, h = b.width / b.height;
                return h > g ^ "contain" === f[0] ? {width: a.height * h, height: a.height} : {
                    width: a.width,
                    height: a.width / h
                }
            }
        ...
        if (!this.transformData) if (this.hasTransform()) {
            var a = this.parseBounds(), b = this.prefixedCss("transformOrigin").split(" ").map(O).map(P);
        ...
        if (!this.transformMatrix) {
            var a = this.prefixedCss("transform"), b = a ? L(a.match(this.MATRIX_PROPERTY)) : null;
        ...
        this.nodes.forEach(function (a) {
            if (ob(a)) {
                ...
                c && -1 !== ["absolute", "fixed"].indexOf(a.css("position")) && b.push([["rect", a.bounds.left + c.left, a.bounds.top + c.top, c.right - c.left, c.bottom - c.top]]), a.clip = T(a) ? a.parent.clip.concat(b) : b, a.backgroundClip = "hidden" !== a.css("overflow") ? a.clip.concat([a.borders.clip]) : a.clip, pb(a) && a.cleanDOM()
        ...
        var b = a.contexts.filter(ab), c = a.children.filter(ob), d = c.filter(nb(lb)),
            e = d.filter(nb(kb)).filter(nb(db)), f = c.filter(nb(kb)).filter(lb), g = d.filter(nb(kb)).filter(db),
            h = a.contexts.concat(d.filter(kb)).filter(cb), i = a.children.filter(qb).filter(fb),
        ...
        var b = a.parseBounds(), c = Math.min(b.width, b.height),
            ...
            g = [1, 1, 1, 1].map(function (a) {
                return {color: new z("#A5A5A5"), width: a}
            }), h = Y(d, f, g);
        this.renderer.clip(a.backgroundClip, function () {
        ...
        var c = a.html2canvas.punycode.ucs2.decode(b.node.data),
            ...
            }) : zb(c), e = b.parent.fontWeight(), f = b.parent.css("fontSize"), g = b.parent.css("fontFamily"),
    ...
    var cc = {inset: [["darken", .6], ["darken", .1], ["darken", .1], ["darken", .6]]};
    S.prototype.parseBorders = function (a) {
        var b = a.parseBounds(), c = hb(a), d = ["Top", "Right", "Bottom", "Left"].map(function (b, c) {
        ...
        return {clip: this.parseBackgroundClip(a, e, d, c, b), borders: W(d, b, e, c)}
    ...
    var dc = 0, ec = "withCredentials" in new XMLHttpRequest, fc = "crossOrigin" in new Image;
