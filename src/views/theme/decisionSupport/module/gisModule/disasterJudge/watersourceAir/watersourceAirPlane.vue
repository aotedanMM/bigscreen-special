<template>
  <div class="DisasterView DisasterMessenger">
    ...
    >
      <template v-slot:title>直升机取水点分布</template>
...
@Component({
  name: 'WatersourceAirPlane',
  components: {
    MapDialog,
  },
  mixins: [MapCommon],
})
export default class WatersourceAirPlane extends Vue {
  ...
  // gis方法param
  private moduleType: any = 'for_watersource';
