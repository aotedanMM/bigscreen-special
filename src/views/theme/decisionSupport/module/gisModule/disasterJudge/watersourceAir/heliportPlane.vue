<template>
  <div class="DisasterView DisasterMessenger">
    ...
    >
      <template v-slot:title>直升机起降点分布</template>
      <template v-slot:unit>处</template>
    </MapDialog>
  </div>
</template>
<script lang="ts">
...
export default class HeliportPlane extends Vue {
  ...
  // gis方法param
  private moduleType: any = 'for_heliport';
