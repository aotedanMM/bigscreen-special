...
export default class HeliportPlaneList extends Vue {
  //  private listDataFlag  = false;
  public title: any = '直升机起降点列表';
  ...
  private clickItemEvent(item: any) {
    ...
    setTimeout(() => {
        this.getComponent_new().locationCenter('for_heliport', item.id);
      }, 500);
  }
