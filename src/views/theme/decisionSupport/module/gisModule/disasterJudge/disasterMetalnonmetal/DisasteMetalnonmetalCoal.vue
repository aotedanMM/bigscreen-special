<template>
    <div class="DisasterView DisasterMessenger">
        ...
        >
            <template v-slot:title>非煤矿山分布</template>
...
<script lang="ts">
  ...
  @Component({
    name: 'DisasteMetalnonmetalCoal',
    components: {
      MapDialog,
    },
    mixins: [MapCommon],
  })
  export default class DisasteMetalnonmetalCoal extends Vue {
    ...
    // gis方法param
    private moduleType: any = 'metalnonmetal';
