...
<script lang="ts">
  ...
  export default class CulturalValuesList extends Vue {
    //  private listDataFlag  = false;
    public title: any = '文化场馆列表';
    ...
    private clickItemEvent(item: any) {
      ...
      setTimeout(() => {
        this.getComponent_new().locationCenter('culturalvenues', item.id);
      }, 500);

      // this.getComponent().openPopup('culturalvenues', item.id);
