<template>
    <div class="DisasterView DisasterMessenger">
        ...
        >
            <template v-slot:title>灾情信息员分布</template>
            <template v-slot:unit>人</template>
        </MapDialog>
    </div>
</template>
<script lang="ts">
...
@Component({
  name: 'DisasterMessenger',
  components: {
    MapDialog,
  },
  mixins: [MapCommon],
})
export default class DisasterMessenger extends Vue {
  ...
  // gis方法param
  private moduleType: any = 'disinfoper';
