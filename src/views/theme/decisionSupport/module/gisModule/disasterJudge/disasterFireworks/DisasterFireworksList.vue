...
export default class DisasterFireworksList extends Vue {
  //  private listDataFlag  = false;
  public title: any = '烟花爆竹企业列表';
  ...
  private clickItemEvent(item: any) {
    ...
    setTimeout(() => {
      this.getComponent_new().locationCenter('firework', item.id);
    }, 500);
