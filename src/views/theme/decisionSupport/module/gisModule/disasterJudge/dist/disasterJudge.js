...
exports.dataSourceConfig = exports.populationSetUnit = exports.populationSetTitle = exports.setUnit = void 0;
// 处理统计面板单位（公里、度区）以及罗马数字
exports.setUnit = function (val, circleType) {
    if (circleType === 0) {
        return val + 'm';
    }
...
exports.populationSetTitle = function (circleType) {
    if (circleType === 0) {
        return 'km';
    }
    else if (circleType === 1) {
...
exports.populationSetUnit = function (val, circleType) {
    if (circleType === 0) {
        return val;
    }
    else if (circleType === 1) {
...
exports.dataSourceConfig = function (val) {
    var rturnData;
    switch (val) {
        case 'House': // 房屋分布
            rturnData = {
