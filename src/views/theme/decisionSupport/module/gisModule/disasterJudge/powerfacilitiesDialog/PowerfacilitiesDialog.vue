<template>
    <div class="DisasterView DisasterMessenger">
        ...
        >
            <template v-slot:title>供电设施</template>
...
<script lang="ts">
  ...
  @Component({
    name: 'PowerfacilitiesDialog',
    components: {
      MapDialog,
    },
    mixins: [MapCommon],
  })
  export default class PowerfacilitiesDialog extends Vue {
    ...
    // gis方法param
    private moduleType: any = 'powerfacilities';
