...
<script lang="ts">
  ...
  export default class DisasterGeologyList extends Vue {
    //  private listDataFlag  = false;
    public title: any = '地质灾害隐患点列表';
    ...
    private FnSourceTypeCode() {
      this.sourceTypeCodeObj = dataSourceConfig('DisasterGeologyList');
    ...
    private clickItemEvent(item: any) {
      ...
      this.getComponent().openPopup('derivativerisk', item.id); // 地质灾害隐患点
