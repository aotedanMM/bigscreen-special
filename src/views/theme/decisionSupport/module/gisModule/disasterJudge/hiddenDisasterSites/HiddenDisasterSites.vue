<template>
    <div class="DisasterView DisasterMessenger">
        ...
        >
            <template v-slot:title>{{sourceObj.title}}分布</template>
...
<script lang="ts">
  ...
  @Component({
    name: 'HiddenDisasterSites',
    components: {
      MapDialog,
    },
    mixins: [MapCommon],
  })
  export default class HiddenDisasterSites extends Vue {
    ...
    // gis方法param
    private moduleType: any = this.sourceObj.key;
