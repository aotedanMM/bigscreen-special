<template>
    <div class="DisasterView">
        ...
        >
            <template v-slot:title>学校分布</template>
            <template v-slot:unit>所</template>
        </MapDialog>
    </div>
</template>
<script lang="ts">
  import {Component, Vue, Prop, Watch} from 'vue-property-decorator';
  import publicDisasterBase from '../publicDisasterBase/publicDisaster.vue';
  ...
  export default class DisasterSchool extends Vue {
    ...
    // gis方法param
    private moduleType: any = 'bas_school';
