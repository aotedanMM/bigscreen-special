<template>
    <div class="DisasterView DisasterMessenger">
        ...
        >
            <template v-slot:title>救援装备分布</template>
...
<script lang="ts">
  ...
  @Component({
    name: 'VEquipmentViewTotal',
    components: {
      MapDialog,
    },
    mixins: [MapCommon],
  })
  export default class VEquipmentViewTotal extends Vue {
    ...
    // gis方法param
    private moduleType: any = 'v_equipment※02';
