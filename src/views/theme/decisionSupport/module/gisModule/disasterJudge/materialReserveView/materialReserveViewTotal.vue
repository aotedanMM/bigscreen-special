<template>
    <div class="DisasterView DisasterMessenger">
        ...
        >
            <template v-slot:title>物资储备库分布</template>
...
<script lang="ts">
  ...
  @Component({
    name: 'MaterialReserveViewTotal',
    components: {
      MapDialog,
    },
    mixins: [MapCommon],
  })
  export default class MaterialReserveViewTotal extends Vue {
    ...
    // gis方法param
    private moduleType: any = 'generalrepository';
