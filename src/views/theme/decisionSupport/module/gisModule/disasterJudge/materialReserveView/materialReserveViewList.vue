...
<script lang="ts">
  ...
  export default class MaterialReserveViewList extends Vue {
    //  private listDataFlag  = false;
    public title: any = '物资储备库列表';
    ...
    private clickItemEvent(item: any) {
      ...
      setTimeout(() => {
        this.getComponent_new().locationCenter('generalrepository', item.id);
      }, 500);


      // this.getComponent().openPopup('generalrepository', item.id);
