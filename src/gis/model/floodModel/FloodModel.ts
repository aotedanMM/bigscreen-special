...
const component = ComponentBase.extend({
  options: {
    ...
    symbolConfig: null,
    serviceConfig: null,
    featureType: 'flood_Layer',
    layerExtent: [119.551, 36.563, 121.95, 37.829],
    arrImg: [],
    arrTime: [],
  },
  // 初始化
  ...
  // 添加imagelayer、
  _add_ImageLayer() {
    const exTend: any = [119.551, 36.563, 121.95, 37.829]; // this.options.arrData[0].pahe;
  ...
  _play(index: any) {
    const self = this;
    const exTend: any = [119.551, 36.563, 121.95, 37.829];
