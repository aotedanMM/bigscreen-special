 ...
 * 流域图层
 */
export default class RainForest extends SimpleRenderMgrLayer {
    ...
    public _getServerData() {
        const self = this;
        this.arrData = [];
        const url = this.options.serviceConfig.floodServer + '/api/gsemergency/natural/autostation/stationLiveDataImg/1/v1';
