...
const component = componentBase.extend({
    ...
    options: {
        ...
        fireAddPopupEventId: 'RiskAnalysisId',
        popupId: 'popup_EventPoints', // 弹窗唯一标识
        highLightId: 'RiskAnalysisComponentHL', // 高亮id
    ...
    initialize(options: any) {
        ...
        // this.map.on('click', this.ss, this);
        this.fistNum = 1;
    ...
    ss(button: any, shift: any, screenX: any, screenY: any, mapX: any, mapY: any, handle: any) {
        let elelayer;
        const allLayer = G.that.map.getLayers();
        ...
        if (elelayer) {
            if (G.that.fistNum === 1) {
                G.that.fistNum = G.that.fistNum + 1;
            ...
            for (const i in elelayer.groupLayers) {
                ...
                if (ele && elelayer.groupLayers[i].name === '模型地图数据') {
                    // G.that.setMapText(ele.element);
                    G.that.closePopup();
                    // $('.RiskAnalysis-tooltip').remove();
                    const areaObj = G.that.getArea();
                    ...
                    G.that.addPopup(ele.element, point);
                }
            }
        } else {
            $('.RiskAnalysis-tooltip').remove();
    ...
    getList(data: any, type: any, eventInfo: any) {
        ...
        if (type === 'Harm') {
            ...
            this.legendData = {
                list: [
                    { name: '有感区', bcolor: { a: 200, r: 0, g: 255, b: 0 }, fcolor: { a: 200, r: 0, g: 255, b: 0 } },
                    { name: '轻伤区', bcolor: { a: 200, r: 0, g: 0, b: 255 }, fcolor: { a: 200, r: 0, g: 0, b: 255 } },
                    { name: '重伤区', bcolor: { a: 200, r: 255, g: 185, b: 15 }, fcolor: { a: 200, r: 255, g: 185, b: 15 } },
                    { name: '死亡区', bcolor: { a: 200, r: 255, g: 45, b: 45 }, fcolor: { a: 200, r: 255, g: 45, b: 45 } },
                ],
                type: 'Harm',
            };
        }
        ...
        if (type === 'UnProtect') {
            ...
            this.legendData = {
                list: [
                    { name: '低风险区', bcolor: { a: 200, r: 0, g: 255, b: 0 }, fcolor: { a: 200, r: 0, g: 255, b: 0 } },
                    { name: '中风险区', bcolor: { a: 200, r: 0, g: 0, b: 255 }, fcolor: { a: 200, r: 0, g: 0, b: 255 } },
                    { name: '高风险区', bcolor: { a: 200, r: 255, g: 0, b: 0 }, fcolor: { a: 200, r: 255, g: 0, b: 0 } },
                ],
                type: 'UnProtect',
            };
        }
        ...
        if (type === 'Build') {
            ...
            this.legendData = {
                list: [
                    ...
                    { name: '塑料起火区', bcolor: { a: 200, r: 0, g: 0, b: 255 }, fcolor: { a: 200, r: 0, g: 0, b: 255 } },
                    { name: '木材起火区', bcolor: { a: 200, r: 238, g: 238, b: 0 }, folor: { a: 200, r: 238, g: 238, b: 0 } },
                    { name: '钢材失效区', bcolor: { a: 200, r: 238, g: 173, b: 14 }, fcolor: { a: 200, r: 238, g: 173, b: 14 } },
                    { name: '建筑起火区', bcolor: { a: 200, r: 255, g: 0, b: 0 }, fcolor: { a: 200, r: 255, g: 0, b: 0 } },
                ],
                type: 'Build',
            };
        }
        ...
        if (type === 'CommonStorage') {
            ...
            this.legendData = {
                list: [
                    { name: '中风险区', bcolor: { a: 200, r: 0, g: 255, b: 0 }, fcolor: { a: 200, r: 0, g: 255, b: 0 } },
                    { name: '高风险区', bcolor: { a: 200, r: 0, g: 0, b: 255 }, fcolor: { a: 200, r: 0, g: 0, b: 255 } },
                ],
                type: 'CommonStorage',
            };
        }
        ...
        for (const key of Object.keys(dataObj)) {
            if (key.indexOf(type) === 0) {
                ...
                if (dataObj.hasOwnProperty(type + '_Lv1-0') && tempSplit.length > 2) {
                    continue;
                }
                const t = tempSplit[0];
                ...
                this.setRing(dataObj[key], index, type, this.legendData.list[index - 1], tempSplit[1]);
                if (index === 1) {
        ...
        const point = new g2.sfs.Point({
            x: data.data.data.Service_Info.Parms_Return.Fire_Info[0].Postion[0],
            y: data.data.data.Service_Info.Parms_Return.Fire_Info[0].Postion[1],
        ...
        if (windDirection !== '无风') {
            ...
            const obj = {
                ...
                point: [data.data.data.Model_Infos.GModel_Fire_Chemical.Parms_Return.ParmsInfo['110601'][0]['110530'][1] * 1, data.data.data.Model_Infos.GModel_Fire_Chemical.Parms_Return.ParmsInfo['110601'][0]['110530'][2] * 1],
                radius,
            };
        ...
        const areaData = {
            type,
            area: this.options.areaObj,
        };
        this.fire('setArea', areaData);
    },
    // 获取图例列表
    getLegendData() {
    ...
    setRing(data: any, type: any, num: any, dataPoint: any, pointNum: any) {
        ...
        // 有感区
        if (type === '1') {
            this.options.areaObj.feel = (area / 1000000).toFixed(2); // (area * 1000000).toFixed(5);
            areaType = 'feel';
        }
        // 轻伤区
        if (type === '2') {
            this.options.areaObj.minorWound = (area / 1000000).toFixed(2); // (area * 1000000).toFixed(5);
            areaType = 'minorWound';
        }
        // 重伤区
        if (type === '3') {
            this.options.areaObj.seriousInjury = (area / 1000000).toFixed(2); // (area * 1000000).toFixed(5);
            areaType = 'seriousInjury';
        }
        // 死亡区
        if (type === '4') {
            this.options.areaObj.death = (area / 1000000).toFixed(2); // (area * 1000000).toFixed(5);
            areaType = 'death';
        }
        if (type === '5') {
            this.options.areaObj.five = (area / 1000000).toFixed(2); // (area * 1000000).toFixed(5);
            areaType = 'five';
        }
        const dataObj = {
            // geom: {
        ...
        const opts = {
            ...
            listeners: {
                ...
                mouseover: (data: any) => {
                    ...
                    // this.mousePosition.on('mousePositionChange', (event: any) => {
                    //     console.log(data[0].element);
                    //     // this.closePopup();
                    //     this.addPopup(data[0].element, event);
                    // });
                },
                mouseout: () => {
        ...
        // const geom = g2.sfs.GeometryFactory.createGeometryFromGeoJson(tLayerDataList);
        // this.map.pan(geom);
        // this.map.zoomTo(9);
    },
    // 清理图层
    clear() {
        ...
        const windLayer = this.map.getLayerById('WindLayer');
        if (windLayer) {
            windLayer.clear();
        }
        this.closePopup();
