...
import FloodDisasterEventInfo from '../event/FloodDisasterEventInfo';
import EventInfo from '../event/EventInfo';
import MessageHandler from './MessageHandler';
/**
 * 洪涝灾害事件处理
 */
export default class FloodDisasterMessageHandler extends MessageHandler {
    ...
    public createEventInfo(): EventInfo {
        return new FloodDisasterEventInfo(null, null);
    }
