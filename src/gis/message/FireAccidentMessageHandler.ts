...
import FireAccidentEventInfo from '../event/FireAccidentEventInfo';
import EventInfo from '../event/EventInfo';
import MessageHandler from './MessageHandler';
/**
 * 火灾事故事件处理
 */
export default class FireAccidentMessageHandler extends MessageHandler {
    ...
    public createEventInfo(): EventInfo {
        return new FireAccidentEventInfo(null, null);
    }
