...
import GrasslandFireEventInfo from '../event/GrasslandFireEventInfo';
import EventInfo from '../event/EventInfo';
import MessageHandler from './MessageHandler';
/**
 * 草原火灾事件处理
 */
export default class GrasslandFireMessageHandler extends MessageHandler {
    ...
    public createEventInfo(): EventInfo {
        return new GrasslandFireEventInfo(null, null);
    }
