...
@Component({
  name: 'GisPlotAroundBtn',
})
export default class GisPlotAroundBtn extends Vue {
  ...
  private clickHandler(item: any) {
    ...
    //       },
    //     ];
    // obj.forEach((item2: any) => {
    //   if (tempFun[item2.key]) {
    //     tempFun[item2.key](this, item2);
    //   }
    // });
  ...
  private initListener() {
    this.messsageBus.off('GisPlotAroundBtn', this.handleCommonToolsClose);
    this.messsageBus.on('GisPlotAroundBtn', this.handleCommonToolsClose);
  }
