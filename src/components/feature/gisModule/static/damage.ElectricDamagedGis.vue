<template>
  <div id="ElectricDamagedGis">
    ...
    <div class="detail" v-show="moduleIsShow">
      ...
      >
        <li>
          输电线路共<span>{{ allEleDamage.road }}</span
          >条
        </li>
        <li>
          变电站共<span>{{ allEleDamage.station }}</span
          >座
        </li>
      </ul>
      <ul class="dieListBox">
        ...
        >
          ...
          <div class="listCont">
            <span> <span>输电线路：</span>{{ i.dianxianhao }}条 </span>
            <span> <span>变电站：</span>{{ i.dianzhancount }}座 </span>
          </div>
        </li>
      </ul>
    </div>
