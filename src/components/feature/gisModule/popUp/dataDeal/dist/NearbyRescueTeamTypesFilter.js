...
exports.NearbyRescueTeamTypesPopUpRule = exports.NearbyRescueTeamTypesFilter = void 0;
// 周边分析对应弹窗规则
// 学校
var school = {
    name: '学校',
...
var NearbyRescueTeamTypesFilter = [
    'Nearbybas_school',
    'Nearbyhospital',
    'Nearbygovernment',
    'Nearbymarket',
    ...
    'NearbyGymnasium',
    'Nearbytourist',
    'Nearbyculturalvenues',
    'Nearbypowerfacilities',
    'Nearbysupwatfacil',
    'Nearbypowerfacil',
    'Nearbygasfacil',
    'Nearbysluice',
...
exports.NearbyRescueTeamTypesFilter = NearbyRescueTeamTypesFilter;
var NearbyRescueTeamTypesPopUpRule = {
    Nearbybas_school: school,
    Nearbyhospital: hospital,
    Nearbygovernment: government,
    Nearbymarket: market,
    ...
    Nearbysupwatfacil: powerfacilities,
    Nearbypowerfacilities: powerfacilities,
    Nearbygasstation: gasstation
};
exports.NearbyRescueTeamTypesPopUpRule = NearbyRescueTeamTypesPopUpRule;
