...
export default class FloodForecast extends Vue {
  private time: any = '';
  ...
  public getComponent() {
    ...
    const component = factory.ModelDisplayFactory.getComponent('FloodModel');
    return component;
  }
  // 点击开始/关闭按钮
  private playFn() {
  ...
  private created(): void {
    this.getComponent().getTimeInfo().then((res: any) => {
        ...
        this.getComponent()._add_ImageLayer();
      });
  }
  // 页面销毁
  private destroyed() {
