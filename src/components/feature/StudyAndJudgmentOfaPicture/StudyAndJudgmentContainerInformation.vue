<template>
  <div style="height:100%">
    <StudyAndJudgmentInformationHalf
...
import StudyAndJudgmentInformationHalf from '@/components/feature/StudyAndJudgmentOfaPicture/StudyAndJudgmentInformationHalf.vue';
...
@Component({
  name: 'StudyAndJudgmentContainerInformation',
  components: {
    HalfList,
    StudyAndJudgmentInformationHalf,
    RainMonitor,
...
export default class StudyAndJudgmentContainerInformation extends Vue {
